...
const processColors = (preset) =>
  Object.keys(cssVariables[preset]).reduce((acc, key) => {
    const name = key.replace('--', '')
    if (name.endsWith('opacity') || name.endsWith('gap')) return acc
    acc[name] = getColour(name, preset)
    return acc
  }, {})

const processedRootColors = processColors('root')
...
export default {
  ...
  components: {
    VaSidebarItem: {
      activeColor: 'primary-hover'
      // hoverColor: 'backgroundPrimary'
    }
  },
